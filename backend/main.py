...
from api.routes import topics, angles, scripts
...
app = FastAPI(title="shorts-agent", version="0.3.0", lifespan=lifespan)
...
@app.get("/api/health")
def health():
    return {"status": "ok", "service": "shorts-agent", "version": "0.3.0",
